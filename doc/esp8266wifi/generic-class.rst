...
Para ver un ejemplo de aplicación con ``WiFiEventHandler``, comprueba la seccion separada con `ejemplos <generic-examples.rst>`__ dedicado especificamente a la clase genérica.

...
Para detalles específicos consulta la sección `Modulo Generico ESP8266 <../boards.rst#generic-esp8266-modules>`__ . Ejemplos de módulos sin convertidor USB a Serie en la tarjeta:

...
Para detalles específicos consulta la sección `Módulo Genérico ESP8266 <../boards#generic-esp8266-modules>`__. Ejemplos de módulos sin convertidor USB a Serie en la tarjeta:
